...
/usr/bin/brave-origin-stable --app="http://127.0.0.1:8080" --kiosk --class=WebApp-Dashboard --name=WebApp-Dashboard --no-first-run --noerrdialogs --disable-context-menu --force-renderer-accessibility --use-gl=desktop --disable-gpu-compositing --password-store=basic